...
// static char *font= { "font-awesome:10"  };
...
static unsigned int defaultcs = 251;
...
static char *openurlcmd[] = { "/bin/sh", "-c",
    "sed 's/.*│//g' | tr -d '\n' | grep -aEo '(((http|https)://|www\\.)[a-zA-Z0-9.]*[:]?[a-zA-Z0-9./&%?=_-]*)|((magnet:\\?xt=urn:btih:)[a-zA-Z0-9]*)'| uniq | sed 's/^www./http:\\/\\/www\\./g' | tail -r| dmenu -i -p 'Follow which url?' -l 10 | xargs -r xdg-open",
    "externalpipe", NULL };
...
//static char *copylast[] = { "/bin/sh", "-c", "getLast", "externalpipe", NULL };
...
//	{ MODKEY,               XK_Num_Lock,    numlock,        {.i =  0} },
	...
	{ MODKEY,               XK_k,           kscrollupfast,      {.i =  1} },
	{ MODKEY,               XK_j,           kscrolldownfast,    {.i =  1} },
...
//	{ MODKEY,               XK_d,           externalpipe,   {.v = copylast   } },
